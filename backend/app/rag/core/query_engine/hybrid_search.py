...
from app.rag.core.types import ProcessedQuery, RetrievalResult

if TYPE_CHECKING:
    from app.rag.core.query_engine.dense_retriever import DenseRetriever
    from app.rag.core.query_engine.fusion import RRFFusion
    from app.rag.core.query_engine.query_processor import QueryProcessor
    from app.rag.core.query_engine.sparse_retriever import SparseRetriever
