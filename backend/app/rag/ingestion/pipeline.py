...
from app.rag.core.settings import Settings, resolve_path
from app.rag.core.types import Document, Chunk
from app.rag.core.trace.trace_context import TraceContext
from app.rag.observability.logger import get_logger

# Libs layer imports
from app.rag.libs.loader.file_integrity import SQLiteIntegrityChecker
...
from app.rag.ingestion.transform.metadata_enricher import MetadataEnricher
from app.rag.ingestion.transform.image_captioner import ImageCaptioner
...
from app.rag.ingestion.embedding.batch_processor import BatchProcessor
...
from app.rag.ingestion.storage.image_storage import ImageStorage
...
class IngestionPipeline:
    ...
    Example:
        >>> from app.rag.core.settings import load_settings
    ...
    def __init__(
        ...
        logger.info("  ✓ Loader will be determined per file type")
    ...
    def run(
        ...
        try:
            ...
            _t0 = time.monotonic()
            from app.rag.libs.loader.pdf_loader import load_document
