...
from app.rag.libs.llm.base_llm import BaseLLM
from app.rag.libs.llm.base_vision_llm import BaseVisionLLM
...
def _register_vision_providers() -> None:
    ...
    """
    try:
        from app.rag.libs.llm.azure_vision_llm import AzureVisionLLM
    ...
    try:
        from app.rag.libs.llm.openai_vision_llm import OpenAIVisionLLM
        from app.rag.libs.llm.llm_factory import LLMFactory
