...
-- 初始化数据
-- 密码是 12345678（MD5 加密 + 盐值 xcodd）
INSERT INTO user (id, userAccount, userPassword, userName, userAvatar, userProfile, userRole) VALUES
(1, 'admin', '5802ab8b34cda7cfa3a5847e302b9952', '管理员', 'https://api.dicebear.com/7.x/avataaars/svg', '系统管理员', 'admin'),
(2, 'user', '5802ab8b34cda7cfa3a5847e302b9952', '普通用户', 'https://api.dicebear.com/7.x/avataaars/svg', '我是一个普通用户', 'user'),
(3, 'test', '5802ab8b34cda7cfa3a5847e302b9952', '测试账号', 'https://api.dicebear.com/7.x/avataaars/svg', '这是一个测试账号', 'user');
